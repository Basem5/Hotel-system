import java.io.File;                     // welcome to my project enjoy :) //
...
{
    int itemno; // declare varibles
    int quantity;   
    float price;
    
    Food(int itemno,int quantity)
    {
        this.itemno=itemno; // use this cuz we going to use yhis variables in diff calsss
        this.quantity=quantity;
        switch(itemno)
        {
            case 1:price=quantity*50; //work like  switch
                break;
...
class Hotel
{
    ...
    static void bookroom(int i)
    {
        ...
        switch (i) {
            case 1:
                ...
                System.out.print("\nEnter room number: ");
                try{  // try and cathch for exception
                rn=sc.nextInt();
                rn--;
    ...
    static void deallocate(int rn,int rtype) // detailes after checout
    {
        int j;
        char w;
        switch (rtype) {
...
public class Main { // here where the programe starts
